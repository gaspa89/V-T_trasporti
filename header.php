			...
			<div class="container-fluid">
				<div class="position-relative">
					<div class="logo-desktop">
						<img src="/img/logo-sito-web-verticale.png" alt="V&T Trasporti">
					</div>
				</div>
				...
				<div class="row header">
					<div class="col-sm-3 col-md-3 col-lg-3">
						<!-- <a href="index.php" id="logo" class="logo-mobile"></a> -->
						<center><img class="logo-mobile" src="/img/logo-sito-web-verticale.png" alt="V&T Trasporti"></center>
					</div>
					<div id="contatti-header" class="col-sm-offset-1 col-md-offset-1 col-lg-offset-1 col-sm-8 col-md-8 col-lg-8">
						<div class="text-right header-padding">
							<div class="h-block"><span>CONTATTI</span>+39 351 599 7960</div>
